        ...
        <%
            ...
            if ((contentType.indexOf("multipart/form-data") >= 0)) {
                ...
                try {
                    ...
                    response.sendRedirect("markaresimekle.jsp");
                }
            } else {
                                    ...
                                    <ul class="sidebar-menu" id="nav-accordion">
                                        ...
                                        <li class="sub-menu">
                                            ...
                                            <ul class="sub">
                                                ...
                                                <li><a  href="markaresimekle.jsp">Marka Listele</a></li>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="kargoform" method="get" action="markalisteleme.jsp">
                                        <div class="form-group ">
                                            <label for="markaad" class="control-label col-lg-2">Marka Adi</label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="markaad" name="markaad" type="text" />
                                            </div>
                                        </div>
                                        <div class="form-group ">
