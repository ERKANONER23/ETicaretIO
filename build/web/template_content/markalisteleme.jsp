...
<%
    ...
    String markaad = request.getParameter("markaad");
    if (markaad != null) {
        ...
        Marka marka = new Marka(0, markaad, aciklama, resimyolu);
        int etkilenen = markaDAO.insert(marka);
        if (etkilenen > 0) {
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%                                                        
                                                        ...
                                                        List<Marka> markaList = markaDAO.markaFullList();

                                                        Iterator<Marka> iterator = markaList.iterator();

                                                        while (iterator.hasNext()) {
                                                            Marka marka = iterator.next();
                                                            out.print("<tr>");
                                                            out.print("<td>");
                                                            out.print(marka.getId());
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print(marka.getAd());
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print(marka.getAciklama());
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print(marka.getResimYol());
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print("<img src=" + marka.getResimYol() + " width='30'>");
                                                            out.print("</td>");
