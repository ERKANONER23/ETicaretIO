...
<html lang="en">
    ...
    <link rel="shortcut icon" href="img/favicon.png">
        ...
        <title>Kategori Listeleri</title>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        Iterator<Kategori> iterator = kategoriList.iterator();

                                                        while (iterator.hasNext()) {
                                                            Kategori kategori = iterator.next();
                                                            out.print("<tr>");
                                                            out.print("<td>");
                                                            out.print(kategori.getId());
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print(kategori.getAd());
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print(kategori.getAciklama());
                                                            out.print("</td>");
                                                            out.print("<td>");
