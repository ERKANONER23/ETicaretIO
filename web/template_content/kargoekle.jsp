...
<%
    ...
    if (form != null) {
        String sirketAd = request.getParameter("sirketadi");
        String adres = request.getParameter("adres");
        String telefon = request.getParameter("telefon");
        String websitesi = request.getParameter("website");
        String email = request.getParameter("email");
        int id = 0;
        Kargo kargo = new Kargo(id, sirketAd, adres, telefon, websitesi, email);
        KargoDAO kargoDAO = new KargoDAO();
        int etkilenen=kargoDAO.insert(kargo);
        
        if(etkilenen>0){
            mesaj="Bilgiler Eklenmistir";
            response.sendRedirect("kargolistele.jsp");
        }else{
                                    ...
                                    <div class="col-lg-12">
                                        <section class="panel">
                                            ...
                                            <div class="panel-body">
                                                <div class="form">
                                                    <form class="cmxform form-horizontal tasi-form" id="kargoform" method="get" action="kargoekle.jsp">
                                                        <div class="form-group ">
                                                            <label for="sirketadi" class="control-label col-lg-2">Sirket Adi</label>
                                                            <div class="col-lg-10">
                                                        ...
                                                        <div class="form-group ">
                                                            <label for="website" class="control-label col-lg-2">Web sitesi</label>
                                                            <div class="col-lg-10">
