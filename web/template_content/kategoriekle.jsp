                                    ...
                                    <div class="col-lg-12">
                                        <section class="panel">
                                            ...
                                            <div class="panel-body">
                                                <div class="form">
                                                    <form class="cmxform form-horizontal tasi-form" id="kargoform" method="get" action="kategoriekle.jsp">
                                                        <div class="form-group ">
                                                            <label for="kategoriadi" class="control-label col-lg-2">Kategori Adi</label>
                                                            <div class="col-lg-10">
